...
LABELS = open(COCONAMES_PATH).read().strip().split("\n")
...
logger("loading YOLO from disk..." ,LOGGER)
net = cv2.dnn.readNetFromDarknet(CONFIG_PATH, WEIGHTS_PATH)
logger("YOLO loaded" ,LOGGER)
...
while True:
	...
	if writer is None:
		...
		writer = cv2.VideoWriter("new_videox.mp4", fourcc, 30,
...
print("[INFO] cleaning up.... Total time:", time.time() - start_time)
writer.release()
vs.release()